...
?>
        <label for="awa-field"><?php esc_html_e('Hide the page title', 'awa'); ?></label>
        <select name="awa" id="awa-field" class="postbox">
            <option value=""><?php esc_html_e('Select', 'awa'); ?></option>
            <option value="yes" <?php selected($value, 'yes'); ?>>
                <?php esc_html_e('Yes', 'awa'); ?>
            </option>
            <option value="no" <?php selected($value, 'no'); ?>>
                <?php esc_html_e('No', 'awa'); ?>
            </option>
        </select>
<?php
    }
